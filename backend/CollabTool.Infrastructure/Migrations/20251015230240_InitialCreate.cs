    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkspacesUser", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkspacesUser_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkspacesUser_Workspaces_WorkspaceId",
                        column: x => x.WorkspaceId,
                        principalTable: "Workspaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskCards_BoardLists_BoardListId",
                        column: x => x.BoardListId,
                        principalTable: "BoardLists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskCards_Users_AssignedToUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskCards_AssignedToUserId",
                table: "TaskCards",
                column: "AssignedToUserId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskCards_BoardListId",
                table: "TaskCards",
                column: "BoardListId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkspacesUser_UserId",
                table: "WorkspacesUser",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkspacesUser_WorkspaceId_UserId",
                table: "WorkspacesUser",
